...
function findWasmBinary() {
  return locateFile('ngspice.wasm');
}
...
var _ngSpice_Init = Module['_ngSpice_Init'] = makeInvalidEarlyAccess('_ngSpice_Init');
var _ngSpice_Command = Module['_ngSpice_Command'] = makeInvalidEarlyAccess('_ngSpice_Command');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ngSpice_Init'] != 'undefined', 'missing Wasm export: ngSpice_Init');
  assert(typeof wasmExports['ngSpice_Command'] != 'undefined', 'missing Wasm export: ngSpice_Command');
  ...
  _ngSpice_Init = Module['_ngSpice_Init'] = createExportWrapper('ngSpice_Init', 7);
  _ngSpice_Command = Module['_ngSpice_Command'] = createExportWrapper('ngSpice_Command', 1);
